        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 dark:bg-gray-900 p-6">
                ...
                <div class="p-6 bg-white dark:bg-white/[0.03] rounded-lg shadow">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">Dashboard Content</h2>
                    <p class="text-gray-600 dark:text-gray-300">This is where your dashboard content will go. Add your widgets, charts, and statistics here.</p>
                </div>
            </main>
        </div>
    </div>
